...
class CrashDump{
	...
	private function extraData(){
		...
		if($this->server->getProperty("auto-report.send-settings", true) !== false){
			...
			$this->data["genisys.properties"] = @file_get_contents($this->server->getDataPath() . "genisys.properties");
			$this->data["genisys.properties"] = preg_replace("#^rcon\\.password=(.*)$#m", "rcon.password=******", $this->data["genisys.properties"]);
			$this->data["pocketmine.yml"] = @file_get_contents($this->server->getDataPath() . "pocketmine.yml");
		}else{
			$this->data["pocketmine.yml"] = "";
			$this->data["genisys.properties"] = "";
